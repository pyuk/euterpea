...
/* package euterpea-0.1.0.0 */
#define VERSION_euterpea "0.1.0.0"
#define MIN_VERSION_euterpea(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package Euterpea-1.1.1 */
#define VERSION_Euterpea "1.1.1"
#define MIN_VERSION_Euterpea(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "euterpea-0.1.0.0"

#define CURRENT_PACKAGE_KEY "euterpea-0.1.0.0"
